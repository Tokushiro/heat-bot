...
if (serverIP) {
    console.log("Loaded SERVER_IP:", serverIP);
} else {
    console.log("SERVER_IP not provided; relying on localhost/host headers");
}
...
if (serverIP) {
    allowedOrigins.push(`http://${serverIP}:5173`); // PC LAN IP with Vite port
}
